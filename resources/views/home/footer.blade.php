  ...
  <div class="footer-top">
    <div class="container">
      <div class="row">
        <div class="col-sm-6">
          <address>
            <p>Dapatkan "info kos murah" hanya di</p>
            <p class="mb-4">KOSTin App</p>
            <div class="d-flex align-items-center">
              <p class="mr-4 mb-0">+3 123 456 789</p>
              <a href="mailto:info@yourmail.com" class="footer-link">cs@kostin.com</a>
            </div>
            <div class="d-flex align-items-center">
              <p class="mr-4 mb-0">+1 222 345 342</p>
              <a href="mailto:Marshmallow@yourmail.com" class="footer-link">kostin@yourmail.com</a>
            </div>
          </address>
  ...
  <div class="footer-bottom">
    <div class="container">
      <div class="d-flex justify-content-between align-items-center">
        <div class="d-flex align-items-center">
          <img src="{{asset('home/images/logo3.png')}}" alt="logo" class="mr-3">
          <p class="mb-0 text-small pt-1">© 2022<a href="#" class="text-white" target="_blank">KOSTin</a>. All rights reserved.</p>
        </div>
        <div>
          <div class="d-flex">
