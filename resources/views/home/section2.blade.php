    ...
    <div class="row" data-aos="fade-up">
      <div class="col-sm-4 text-center text-lg-left">
        <div class="services-box" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
          <img src="{{asset('home/images/integrated-marketing.svg')}}" alt="integrated-marketing" data-aos="zoom-in">
      ...
      <div class="col-sm-4 text-center text-lg-left">
        <div class="services-box"   data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
          <img src="{{asset('home/images/design-development.svg')}}" alt="design-development" data-aos="zoom-in">
      ...
      <div class="col-sm-4 text-center text-lg-left">
        <div class="services-box" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
          <img src="{{asset('home/images/digital-strategy.svg')}}" alt="digital-strategy" data-aos="zoom-in">
    ...
    <div class="row" data-aos="fade-up">
      <div class="col-sm-4 text-center text-lg-left">
        <div class="services-box  pb-lg-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
          <img src="{{asset('home/images/digital-marketing.svg')}}" alt="digital-marketing" data-aos="zoom-in">
          <h6 class="text-dark mb-3 mt-4 font-weight-medium">Digital 
            Marketing
          </h6>
          <p>Lorem ipsum dolor sit amet, 
      ...
      <div class="col-sm-4 text-center text-lg-left">
        <div class="services-box pb-lg-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
          <img src="{{asset('home/images/growth-strategy.svg')}}" alt="growth-strategy" data-aos="zoom-in">
      ...
      <div class="col-sm-4 text-center text-lg-left">
        <div class="services-box pb-0" data-aos="fade-down" data-aos-easing="linear" data-aos-duration="1500">
          <img src="{{asset('home/images/saving-strategy.svg')}}" alt="saving-strategy" data-aos="zoom-in">
