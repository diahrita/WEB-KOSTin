...
class KostController extends Controller
{
    public function KostView()
    {
        ...
        return view('backend.kost_data.view_kost', $datakost); //manampilkan view yg ada di folder backend
    }
    public function KostAdd()
    {
        // $allDataUser=User::all();
        // $data['allDataDataKost'] = DataKost::all();
        return view('backend.kost_data.add_kost');
    }
    public function KostBaru(Request $request)
    {
        // dd($request->all());
        ...
        return to_route('kost.view')->with('Tambah Data Kost Berhasil!');
    }

    public function KostEdit($id)
    {
        $editKost = DataKost::find($id);
        return view('backend.kost_data.edit_kost', compact('editKost'));
    }
    public function KostUpdate(Request $request, $id)
    {
        ...
        return redirect()->route('kost.view')->with('info', 'Update Data Kost Berhasil');
    }
    public function DataKostDelete($id)
    {
        ...
        return redirect()->route('kost.view')->with('info', 'Delete Data Kost Berhasil');
    }
}
